    ...
    <footer className={styles.footer__container}>
      <div className={styles.footer__wrapper}>
          ...
          <div className={styles.footer__about}>
            ...
            <h3
              className={classNames(
                styles.footer__about_title,
                styles.footer__hidden,
              )}
            >
              Пример текста
            </h3>
            <p
              className={classNames(
                styles.footer__about_subtitle,
                styles.footer__hidden,
              )}
            >
              Пример текста пример текста пример текста пример текста пример
        ...
        <div className={styles.footer__contacts}>
          ...
          <form
            className={classNames(
              styles.footer__phone_number,
              styles.footer__hidden,
            )}
            onSubmit={handleSubmit(() => {})}
          >
            <Input
              className={styles.footer__input_phone}
              register={register}
              nameInput={"Phone"}
            />
            <Button
            ...
            <div className={styles.footer__form_error}>
              {errors?.Phone && (
                <p>{errors?.Phone?.message || "введите номер телефона"}</p>
              )}
            </div>
          </form>
        </div>
